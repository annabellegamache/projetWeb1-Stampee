...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 27 sep. 2022 à 23:03
...
(5, 'Reine Elizabeth 2', '0', '2022-09-12 06:36:00', '2022-11-22 06:36:00', 680, 600, 600, 0, 5, 3),
(6, 'Reine Couronnement', '0', '2022-09-05 06:37:00', '2022-11-23 06:37:00', 900, 800, 800, 0, 6, 3),
(7, 'Charles Péguy', '0', '2022-09-26 06:50:00', '2022-10-17 06:50:00', 500, 475, 475, 0, 7, 2),
(8, 'Aérien poste', '0', '2022-09-19 06:51:00', '2022-11-16 06:51:00', 850, 700, 700, 0, 9, 2),
(9, 'Train Canada', '2', '2022-09-19 06:51:00', '2022-11-15 06:51:00', 550, 400, 400, 0, 10, 2),
(10, 'Conférence Lord', '0', '2022-09-29 06:52:00', '2022-10-06 06:52:00', 850, 810, 810, 2, 11, 2),
...
CREATE TABLE `timbre` (
  ...
  `tim_date_creation` year(4) NOT NULL,
...
(1, 'voilier', 'Macaroon croissant gingerbread soufflé carrot cake cookie gingerbread. Danish tart dessert biscuit pastry. Cookie jujubes soufflé chocolate brownie apple pie sweet pie pastry', 2022, 'Royaume-Unis', 'bleu', 'Entièrement neuf', '55 X 24', 1, 1),
(2, 'quebecEpoque', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Consequat semper viverra nam libero. Aliquet risus feugiat in ante metus. Laoreet non curabitur gravida arcu ac. Velit egestas dui id ornare.', 1915, 'Canada', 'violet', 'Comme neuf', '60 X 40', 1, 3),
(3, 'ferme', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Consequat semper viverra nam libero. Aliquet risus feugiat in ante metus. Laoreet non curabitur gravida arcu ac. Velit egestas dui id ornare', 1923, 'Canada', 'orange', 'Très bon', '30 X 56', 0, 3),
(4, 'roiGeorge', 'Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Consequat semper viverra nam libero.', 0000, 'Royaume-Unis', 'vert', 'Entièrement neuf', '45 X 74', 1, 3),
(5, 'reineJeune', 'Aliquet risus feugiat in ante metus. Laoreet non curabitur gravida arcu ac. Velit egestas dui id ornare', 1939, 'Canada', 'vert', 'Bon Acceptable', '30 X 35', 0, 3),
(6, 'reineEpoque', 'Lorem ipsum dolor sit amet, Laoreet non curabitur gravida arcu ac. Velit egestas dui id ornare. Consectetur adipiscing elit, sed do eiusmod tempor incididunt.', 1944, 'Royaume-Unis', 'violet', 'Comme neuf', '60 X 40', 1, 3),
(7, 'CharlesPeguy', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1920, 'France', 'gris', 'Comme neuf', '55 X 36', 1, 2),
(9, 'Ange avion', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1957, 'Australie', 'rouge', 'Très bon', '30 X 84', 1, 2),
(10, 'train', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1971, 'Canada', 'gris', 'Très bon', '45 X 78', 0, 2),
(11, 'lordConference', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 0000, 'Royaume-Unis', 'brun', 'Comme neuf', '55 X 40', 1, 2),
(13, 'MinistreCanada', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1937, 'Canada', 'brun', 'Entièrement neuf', '60 X 40', 0, 1),
(15, 'ChateauFrance', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1951, 'France', 'bleu', 'Entièrement neuf', '30 X 56', 1, 1),
(16, 'Penseur', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1967, 'Russie', 'bleu', 'Comme neuf', '30 X 56', 0, 1),
(17, 'PresidentNicaragua', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1965, 'Nicaragua', 'bleu', 'Très bon', '40 X 68', 0, 1),
(18, 'Hitler', 'Metus vulputate eu scelerisque felis imperdiet proin fermentum. Laoreet suspendisse interdum consectetur libero. Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. Mauris a diam maecenas sed.', 1924, 'Allemagne', 'rouge', 'Entièrement neuf', '60 X 40', 1, 1);
